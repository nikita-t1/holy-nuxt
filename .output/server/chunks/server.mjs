import { ref, onServerPrefetch, computed, defineComponent, inject, provide, h, Suspense, Transition, reactive, useSSRContext, withAsyncContext, mergeProps, unref, defineAsyncComponent, isRef, getCurrentInstance, toRef, resolveComponent, watchEffect, markRaw, withCtx, createTextVNode, shallowRef, createApp, onErrorCaptured, openBlock, createBlock } from 'vue';
...
const meta$1 = void 0;
const _imports_0 = "" + globalThis.__buildAssetsURL("software-developer-working-on-code-screen-close-up.96519a18.mp4");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex bg-indigo-100 max-w-screen-xl justify-between mx-auto py-10 px-10 w-full" }, _attrs))} data-v-099260f3><div class="video-wrapper" data-v-099260f3><video autoplay loop muted playsinline data-v-099260f3><source${ssrRenderAttr("src", _imports_0)} type="video/mp4" data-v-099260f3> Your browser does not support the video tag. </video><div class="header space-y-4" data-v-099260f3><span class="bg-slate-50 text-blue-800 text-xs px-2.5 py-0.5 rounded" data-v-099260f3>Badge</span><h1 data-v-099260f3>Introduction ...</h1><div class="space-x-4" data-v-099260f3><button class="text-white bg-blue-500 hover:bg-blue-600 rounded-md text-sm px-5 py-2.5" type="button" data-v-099260f3>`);
  ...
  _push(`</button><button class="text-white outline-blue-500 outline outline-2 hover:bg-blue-500 rounded-md text-sm px-5 py-2" type="button" data-v-099260f3>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "font-bold",
    to: "/locked"
  }, {
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/IntroCard.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const IntroCard = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-099260f3"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100" }, _attrs))} data-v-5d2d35ee><h5 class="mb-2 text-2xl font-semibold tracking-tight" data-v-5d2d35ee>${ssrInterpolate(formatDate(props.pray.date))}</h5><div class="table" data-v-5d2d35ee><p data-v-5d2d35ee>Assembly on Site</p>`);
      if (props.pray.onSite) {
        _push(`<p data-v-5d2d35ee>\u2705</p>`);
      } else {
        _push(`<p data-v-5d2d35ee>\u274C</p>`);
      }
      _push(`</div><div class="table" data-v-5d2d35ee><p data-v-5d2d35ee>Livestream</p>`);
      if (props.pray.stream) {
        _push(`<p data-v-5d2d35ee>\u2705</p>`);
      } else {
        _push(`<p data-v-5d2d35ee>\u274C</p>`);
      }
      _push(`</div><div class="table" data-v-5d2d35ee><span class="font-semibold" data-v-5d2d35ee>Opening: </span><p data-v-5d2d35ee>${ssrInterpolate(formatTime(props.pray.date))}</p></div><div class="table" data-v-5d2d35ee><span class="font-semibold" data-v-5d2d35ee>Reaper: </span><p data-v-5d2d35ee>${ssrInterpolate(props.pray.reaper)}</p></div></div>`);
    };
  }
});
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-5d2d35ee"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: pray } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("pray", async () => {
      const { data } = await client.from("pray").select().gte("date", new Date().toISOString()).order("date", { ascending: true }).limit(3);
      return data;
    })), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_EventCard = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col bg-indigo-100 max-w-screen-xl justify-between mx-auto px-2 w-full" }, _attrs))}><h1 class="p-6 pl-0 font-bold text-3xl"> Upcoming Events </h1><div class="flex justify-evenly flex-col lg:flex-row lg:space-x-6 space-y-2 lg:space-y-0"><!--[-->`);
      ssrRenderList(unref(pray), (prayer) => {
        _push(`<div class="grow w-full md:w-2/3 lg:w-full self-center">`);
        _push(ssrRenderComponent(_component_EventCard, { pray: prayer }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]--></div></div>`);
    };
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/UpcomingEvents.vue");
...
const _routes = [
  {
    name: "About",
    path: "/About",
    file: "C:/Users/Nikita/Documents/GitHub/holy-nuxt/pages/About.vue",
    children: [],
    meta: meta$3,
    alias: [],
    component: () => import('./About.77b17261.mjs').then((m) => m.default || m)
  },
  {
    name: "Locked",
    path: "/Locked",
    file: "C:/Users/Nikita/Documents/GitHub/holy-nuxt/pages/Locked.vue",
    children: [],
    meta: meta$2,
    alias: (meta$2 == null ? void 0 : meta$2.alias) || [],
    component: () => import('./Locked.793080f6.mjs').then((m) => m.default || m)
  },
  {
    name: "Login",
    path: "/Login",
    file: "C:/Users/Nikita/Documents/GitHub/holy-nuxt/pages/Login.vue",
    children: [],
    meta: meta$1,
    alias: [],
    component: () => import('./Login.3c51459b.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "C:/Users/Nikita/Documents/GitHub/holy-nuxt/pages/index.vue",
    children: [],
    meta,
    alias: [],
    component: () => import('./index.7d44a795.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.3da7dfab.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import('./default.92ff6d6c.mjs').then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, { class: "bg-indigo-100" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
...
export { IntroCard as I, _export_sfc as _, useSupabaseClient as a, useAsyncData as b, _sfc_main$2 as c, defineNuxtRouteMiddleware as d, entry$1 as default, useRouter as e, __nuxt_component_0$2 as f, useHead as g, navigateTo as n, useSupabaseUser as u };
